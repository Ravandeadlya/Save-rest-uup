...
# Author: Gagan
# GitHub: https://github.com/deanin/
# Telegram: https://t.me/team_s
# YouTube: https://youtube.com/@dev_n
# Created: 2025-01-11
...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/jyal")],
        ]
    )
...
async def plan(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/hhal")],
        ]
    )
...
async def see_plan(client, callback_query):
    ...
    buttons = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("📜 See Terms", callback_data="see_terms")],
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/khhl")],
        ]
    )
